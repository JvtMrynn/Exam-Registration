...
<meta charset="UTF-8">
    ...
    /* Main Footer */
    footer .main-footer{font-family: 'Acme';box-shadow: -3px -3px 5px black;	padding: 20px 0;	background: #060e4d;    border-top: 2px solid black;}
    ...
    /* Copy Right Footer */
    .footer-copyright {	background-color: #060e4d;	padding: 5px 0;box-shadow: -1px -1px 3px black;border-top:1px solid black;}
    ...
    ul.social-footer2 li a:hover {background-color:darkblue;border-radius:5px;align-items:center;}
    ul.social-footer2 li a {display: block;	height:30px;color:darkblue;width: 30px;text-align: center;}
...
<footer style = "font-size : 18px;" id="footer" class="footer-1">
    ...
    <h2 class="widget-title mylink" style = "font-family:Acme;"><b><a href = "https://southernleytestateu.edu.ph">SLSU</a></b></h2>
    <p style="color:#fff;"><i class="fa fa-map-marker-alt" aria-hidden="true" style = "font-size:15px;color:#fff;"></i>  Address:
    San Roque, Sogod, <br>Southern Leyte, 6606 Philippines.</p>
    </div>
    </div>
    ...
    <li>
    <div class="thumb-content"><a  href="https://www.facebook.com/southernleytestateu/" target="_blank">Contact Us</a></div>	
    </li>
    </ul>
    </div>
    </div>
    ...
    <p style= "color : #0000FF;"><a href="mailto:https://southernleytestateu.edu.ph" title="glorythemes" style="color:orange;"><i class='far fa-envelope' style='font-size:14px'></i> https://southernleytestateu.edu.ph</a></p>
    <p><i class='fas fa-phone-square'></i> +63-912-345-6789</p>
