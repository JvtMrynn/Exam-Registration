...
<head>
    ...
    <!-- Navigation -->
        <nav class="navbar navbar-expand-lg navbar-dark static-top" style="background-color: #060e4d; border-bottom:1px solid black;box-shadow: 3px 3px 5px;">
            <div class="container" style = "font-family:'PT Serif';font-size:22px;padding-right:0px;">
                <a class="navbar-brand" href="https://southernleytestateu.edu.ph" target="_blank">
                    <h3 style = "font-family:'PT Serif';" ><img src="css/images/slsu-logo.png" width="70" style = "border-radius:50%;border:1px black;background-color:white;" height="70" alt="SLSU"/> <span class = "mh3">SLSU</span><br /><p style = "margin-left:5%;font-size:12px;margin-top:0;position:absolute;top:60px">Southern Leyte State University</p></h3>
                </a>
		        ...
		        <div class="card mcon" id = "card">
		            ...
		            <div class="card-footer" id = "card-footer">
				        <div class="d-flex justify-content-center">
					        <a href="register.php" style="text-decoration:none; color:black;">Register Here...</a>
				        </div>
			        </div>
		        </div>
	        </div>
