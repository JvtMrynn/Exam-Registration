...
$query1 = "SELECT * FROM campus_registration where usn = '$user'";
$result = mysqli_query($con, $query1);
$rr = mysqli_num_rows($result);
if (!$rr) {
    echo "<h2 style='color:red;font-family:Bitter;margin-left: 2%;font-weight:600;'>Your Application is not yet approved.</h2>";
} else {
...
?>
    ...
    <body>
        <h1 class="mh1">Campus Selected</h1>   
