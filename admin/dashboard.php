...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top" style="padding:8px;border:none;background-color:#060e4d;border-bottom:1px solid black;box-shadow: 3px 3px 5px black;">
    ...
    <div class="wrapper">
        <div class="sidebar col -l2 -s6">
            <ul>
                <div>
                    <img class="img1" src="../css/images/slsu-logo.png" width="100" height="100" alt="not found" />
                </div>
                <li><a href="dashboard.php"><i class="fas fa-clipboard"></i>Dashboard</a></li>
                <li><a href="dashboard.php?page=manage_users"><i class="fas fa-users"></i>Students</a></li>
                <li><a href="dashboard.php?page=disp_s1"><i class="fas fa-users"></i>Pending Approval</a></li>
                <li><a href="dashboard.php?page=disp_s2"><i class="fas fa-users"></i>Approved</a></li>
            </ul>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <a class="dashboard-stat11" href="dashboard.php?page=disp_s1">
                                            ...
                                            <span class="name">Students Registered<br />Status: Waiting for Approval</span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat" href="dashboard.php?page=disp_s2">
                                            <span class="number"><?php echo "$approvedCount"; ?></span>
                                            <span class="name">Students Registered<br />Status: Approved</span>
                                            <span class="bg-icon"><i class="fa fa-bars"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                ...
                                <div class="row" style="margin-top:3%;">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat1" href="dashboard.php?page=manage_users">
                                            ...
                                            <span class="name">Students Registered<br />For Admission</span>
